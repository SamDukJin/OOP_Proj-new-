...
static constexpr auto qt_meta_stringdata_ZN13DepositWindowE = QtMocHelpers::stringData(
    "DepositWindow"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN13DepositWindowE[] = {
...
Q_CONSTINIT const QMetaObject DepositWindow::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN13DepositWindowE.offsetsAndSizes,
    qt_meta_data_ZN13DepositWindowE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN13DepositWindowE_t,
        // Q_OBJECT / Q_GADGET
...
void *DepositWindow::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN13DepositWindowE.stringdata0))
