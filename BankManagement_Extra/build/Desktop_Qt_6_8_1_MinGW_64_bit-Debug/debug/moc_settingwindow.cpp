...
namespace {
struct qt_meta_tag_ZN13SettingWindowE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN13SettingWindowE = QtMocHelpers::stringData(
    "SettingWindow"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN13SettingWindowE[] = {
...
Q_CONSTINIT const QMetaObject SettingWindow::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN13SettingWindowE.offsetsAndSizes,
    qt_meta_data_ZN13SettingWindowE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN13SettingWindowE_t,
        // Q_OBJECT / Q_GADGET
...
void *SettingWindow::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN13SettingWindowE.stringdata0))
